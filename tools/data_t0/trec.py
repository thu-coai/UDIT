...
class Trec(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        return datasets.DatasetInfo(
            ...
            features=datasets.Features(
                {
                    "label_coarse": datasets.ClassLabel(names=_COARSE_LABELS),
                    "label_fine": datasets.ClassLabel(names=_FINE_LABELS),
    ...
    def _split_generators(self, dl_manager):
        ...
        dl_files = {
            "train": "/home/yourname/data_hf/trec/train_5500.label",
            "test": "/home/yourname/data_hf/trec/TREC_10.label",
        }
        return [
