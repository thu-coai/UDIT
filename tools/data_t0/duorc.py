...
class Duorc(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        base_dir = "/home/yourname/data_hf/duorc/"
        all_downloaded_files = {
            "SelfRC": {
                "train": base_dir + "SelfRC_train.json",
                "dev": base_dir + "SelfRC_dev.json",
                "test": base_dir + "SelfRC_test.json",
            },
            "ParaphraseRC": {
                "train": base_dir + "ParaphraseRC_train.json",
                "dev": base_dir + "ParaphraseRC_dev.json",
                "test": base_dir + "ParaphraseRC_test.json",
            },
        }
        downloaded_files = all_downloaded_files[self.config.name]
