...
DATA_EXT=".jsonl"
DATA_NAMES="MCQA-EXQA-CBQA-TC-SENT-S2T-SUM-PARA"
...
SAVE_PATH="${WORKING_DIR}/results/t0/fp16/ft/${DATA_NAMES}/lr${LR}_G${GRAD_ACC}_bs${NUM_GPUS_PER_WORKER}_${BATCH_SIZE}_num${TRAIN_NUM}/seed${SEED}/"
